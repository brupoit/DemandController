...
const loaderPromise = new Promise((resolve, reject) => {
    ...
    if (typeof google !== 'undefined' && google.charts &&
        ...
        let loaderScript = document.querySelector('script[src="@salesforce/resourceUrl/GoogleChart/js/build/file-loader.js"]');
        if (!loaderScript) {
            // If the loader is not present, add it.
            loaderScript = document.createElement('script');
            // Specify URL directly to pass JS compiler conformance checks.
            loaderScript.src = '@salesforce/resourceUrl/GoogleChart/js/build/file-loader.js';
